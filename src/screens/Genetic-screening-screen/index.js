...
const GeneticScreeingScreen = props => {
  ...
  const serviceOptions = [
    {
      id: 'donor',
      title: 'CGT',
      description: 'Screens for 200+ common conditions.',
    ...
    },
    {
      id: 'surrogacy',
      title: 'CGT Exome',
      description: 'Screens for 600+ conditions. Includes full carrier report.',
      icon: IMG.feter,
      iconType: 'svg',
      price: "$1,800.00",
    },
    ...
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        <View style={styles.optionsContainer}>
          <Medium
            label="Select Your Screening Kit"
            fontSize={mvs(18)}
            numberOfLines={10}
            color={colors.textColor}
                    ...
                    <View style={styles.serviceCardContent}>
                      <View style={styles.serviceTextContainer}>
                        ...
                        <Regular
                          ...
                          fontSize={mvs(14)}
                          color="#8C8C8C"
                          style={{...styles.serviceDescription,width:"88%"}}
                          numberOfLines={2}
                        />
                        <Regular
                          label={option.price}
                          fontSize={mvs(16)}
                          color={colors.textColor}
                          style={{ ...styles.serviceTitle, marginTop: mvs(8) }}
                        />
                      </View>
                    </View>
                  </View>
...
export default GeneticScreeingScreen;

...
const PlacePrivateOfferScreen = props => {
      ...
      <ScrollView 
        ...
        <View style={styles.offerSection}>
          ...
          <TextInput
            ...
            placeholderTextColor={colors.placeholder || '#D9D9D9'}
            value={offerValue}
        ...
        <View style={styles.messageSection}>
          <Medium
            label="You can also include a short message with your proposal (optional)"
            fontSize={mvs(14)}
            numberOfLines={10}
            color={colors.textColorSecondary || '#8C8C8C'}
...
export default PlacePrivateOfferScreen;

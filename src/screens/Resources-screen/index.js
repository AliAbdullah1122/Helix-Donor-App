...
const BulletItem = ({ label, value }) => (
  <View style={styles.bulletItemContainer}>
    <View style={styles.bulletLabelRow}>
      <Text style={[styles.bulletDot, { color: colors.textColor }]}>•</Text>
      <Medium label={label} fontSize={mvs(14)} color={colors.textColor} style={{ fontWeight: '400' }} />
    </View>
    <View style={styles.bulletValueRow}>
      <Text style={[styles.bulletDot, { color: colors.textColorSecondary }]}>•</Text>
      <Regular
        label={value}
        fontSize={mvs(14)}
                      ...
                      <View style={styles.expandedContent}>
                        {item.id === 'ivf' && (
                          <>
                            ...
                            <BulletItem
                              label="Success Rate:"
                              value="Varies by age (approx. 20–50% per cycle)."
                            />

                            <BulletItem
                              label="Timeline:"
                              value="One cycle typically takes 2-3 weeks."
                            />

                            <BulletItem
                              label="Cost:"
                              value="Average $12,000 - $30,000 per cycle (varies by region)."
                            />
                        ...
                        {item.id === 'iui' && (
                          <>
                            ...
                            <BulletItem
                              label="Clinical IUI:"
                              value="Performed by a doctor; may use fertility drugs."
                            />

                            <BulletItem
                              label="At-Home IUI:"
                              value="Self-insemination using sterile kits (needle-free)."
                            />

                            <BulletItem
                              label="Cost:"
                              value="Significantly lower than IVF ($300 – $1,000)."
                            />
                        ...
                        {item.id === 'mrt_ifg' && (
                          <>
                            ...
                            <BulletItem
                              label="Status:"
                              value="Highly specialized; available in limited regions (e.g., UK, parts of Europe)."
                            />

                            <BulletItem
                              label="Purpose:"
                              value="Treating mitochondrial disease and advanced age infertility."
                            />

                            <BulletItem
                              label="Availability:"
                              value="Restricted to specific research centers and clinics."
                            />
                        ...
                        {item.id === 'genetic_testing' && (
                          <>
                            ...
                            <BulletItem
                              label="Screening:"
                              value="Comprehensive testing for over 600 hereditary disorders."
                            />

                            <BulletItem
                              label="Partner:"
                              value="iGenomix provides professional genetic screening services."
                            />
                        ...
                        {item.id === 'procreation_safety' && (
                          <>
                            ...
                            <BulletItem
                              label="STI Screening:"
                              value="Test for HIV, Hepatitis B/C, Syphilis, Gonorrhea, and Chlamydia."
                            />

                            <BulletItem
                              label="Vaccinations:"
                              value="Ensure Rubella and Varicella immunity before pregnancy."
                            />

                            <BulletItem
                              label="Folic Acid:"
                              value="400mcg daily is recommended to prevent birth defects."
                            />
                        ...
                        {item.id === 'legal_resources' && (
                          <>
                            ...
                            <BulletItem
                              ...
                              value="Never exchange money or genetic material without a clinical contract."
                            />

                            <BulletItem
                              label="Parental Rights:"
                              value="Without a legal agreement, genetic donors may be considered legal parents and liable for child support."
                            />

                            <BulletItem
                              label="Surrogacy Laws:"
                              value="Commercial surrogacy is illegal in some regions. Verify your local laws before proceeding."
                            />

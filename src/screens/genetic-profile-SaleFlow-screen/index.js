...
const GeneticProfileSalesFlowScreen = props => {
    ...
    <View style={styles.container}>
      ...
      <KeyboardAvoidScrollview contentContainerStyle={styles.keyboradscrollcontent}>
        ...
        <View style={styles.contentContainerStyle}>
          ...
          <View style={{ paddingHorizontal: mvs(14) }}>
            <Light
              label="Dont Have an expanded genetic carrier screening (CGT)?"
              fontSize={mvs(14)}
              numberOfLines={10}
              color={colors.textColor}
            ...
            />
            <Light
              label="Helix has partnered with iGenomix to help you get your professional CGT."
              fontSize={mvs(14)}
              numberOfLines={10}
              color={colors.textColor}
              style={styles.descriptionText}
            ...
            <View style={{ marginBottom: mvs(20) }}>
              <TouchableOpacity onPress={()=>navigate("CGTScreen")} style={{ ...styles.uploadButton, width: "85%", alignSelf: "center" }}>
                {/* <IMG.UploadWhite width={mvs(24)} height={mvs(24)} /> */}
                <Medium
                  label="Get Your Carrier Screening Test"
                  fontSize={mvs(16)}
                  color={colors.white}
...
export default GeneticProfileSalesFlowScreen;
    ...
    <View style={styles.container}>
      ...
      {!!hasLocationAccess ? (
        <>
          ...
          {/* Floating Show List button over map (above members section) */}
          <View style={styles.showListWrapper}>
            <TouchableOpacity activeOpacity={0.9} style={styles.showListButton}>
              <Row style={{alignItems: 'center', justifyContent: 'center'}}>
                <IMG.Showlist width={mvs(18)} height={mvs(18)} />
                <Medium
                  label="Show List"
                  fontSize={mvs(14)}
                  color={colors.white}
...
export default SearchFromFilterScreen;

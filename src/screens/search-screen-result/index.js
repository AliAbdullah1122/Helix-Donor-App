...
const SearchScreenResult = () => {
       ...
       },
 {
      ...
      image: IMG.SearchBaby,
      imageName: 'SearchBaby.svg',
      image2: IMG.SeacxrhBbayPng,
      image2Name: 'SeacxrhBbayPng.png',
      // from membersNearbyBase
      badge: 'New',
      price: "$800.00 USD",
      mutualMatch: true,
      Subscription: true,
  ...
  <View style={styles.suggestionsSection}>
    ...
    {filteredSuggestions.length > 0 ? (
      ...
      />
          ...
          <View style={styles.showMapWrapper}>
            <TouchableOpacity onPress={() => navigate("SearchResultFilterScreen")} activeOpacity={0.9} style={styles.showMapButton}>
              <Row style={{ alignItems: 'flex-start', justifyContent: "flex-start" }}>
                <IMG.ShowmAPlIST width={mvs(18)} height={mvs(18)} style={{marginLeft:mvs(10)}} />
                <Medium
                  label="Show List"
                  fontSize={mvs(14)}
                  color={colors.white}
                  style={{ marginLeft: mvs(18) }}
                />
              </Row>
            </TouchableOpacity>
          </View>
   ...
   color={colors.textColor}
          ...
          <View style={{
            ...
            <View style={styles.membersHandle} />
            <Medium
              label="Members From Search Results"
              fontSize={mvs(16)}
              // color="#333333"
              color={colors.textColor}
              style={styles.membersTitle}

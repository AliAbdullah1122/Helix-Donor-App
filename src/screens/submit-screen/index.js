    ...
    <View style={{flex: 1, backgroundColor: colors.white}}>
      <ScrollView
        ...
        <View
          ...
          /> */}
          <IMG.submitLogo height={mvs(66)} width={mvs(59)} style={{marginBottom:mvs(190)}}   />
        </View>
              ...
              <>
                ...
                <View style={{alignItems: 'center', marginVertical: mvs(14)}}>
                  ...
                  /> */}
                    ...
                    <IMG.completSubmitSvg height={mvs(120)} width={mvs(120)}   />
                </View>
              </>
            ) : (
              <>
                ...
                <View style={{alignItems: 'center', marginVertical: mvs(14)}}>
                  {/* <Image
                    ...
                    style={{width: mvs(120), height: mvs(120)}}
                  /> */}
                    <IMG.reminderSvg height={mvs(120)} width={mvs(120)}   />
                </View>
              </>
            )}
